...
export class CreatePositionTable1710227255465 implements MigrationInterface {
    name = 'CreatePositionTable1710227255465'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`position\` (\`id\` int NOT NULL AUTO_INCREMENT, \`maCV\` varchar(255) NOT NULL, \`namePosition\` varchar(255) NOT NULL, \`salary\` int NOT NULL, \`description\` varchar(255) NOT NULL, \`createdBy\` varchar(255) NOT NULL DEFAULT 'Admin', \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
