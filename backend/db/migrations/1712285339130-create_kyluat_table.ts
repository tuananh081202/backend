...
export class CreateKyluatTable1712285339130 implements MigrationInterface {
    name = 'CreateKyluatTable1712285339130'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`ky_luat\` (\`id\` int NOT NULL AUTO_INCREMENT, \`MaKyLuat\` varchar(255) NOT NULL, \`TenKyLuat\` varchar(255) NOT NULL, \`NgayQuyetDinh\` varchar(255) NOT NULL, \`TenLoai\` varchar(255) NOT NULL, \`HinhThuc\` varchar(255) NOT NULL, \`SoTien\` varchar(255) NOT NULL, \`NgayKyLuat\` varchar(255) NOT NULL, \`MoTa\` varchar(255) NOT NULL, \`NguoiTao\` varchar(255) NOT NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleted_at\` datetime(6) NULL, \`userId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`ky_luat\` ADD CONSTRAINT \`FK_993ac777d8e50b036e0581e7299\` FOREIGN KEY (\`userId\`) REFERENCES \`user\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`user\` DROP FOREIGN KEY \`FK_059ff623ea9dc92164c2f786cec\``);
        await queryRunner.query(`ALTER TABLE \`user\` DROP FOREIGN KEY \`FK_93af21ecba4fa43c4c63d2456cd\``);
        await queryRunner.query(`ALTER TABLE \`ky_luat\` DROP FOREIGN KEY \`FK_993ac777d8e50b036e0581e7299\``);
        await queryRunner.query(`ALTER TABLE \`reward\` DROP FOREIGN KEY \`FK_7b3e48d8a28c1d1422f19c60752\``);
        await queryRunner.query(`ALTER TABLE \`account\` DROP FOREIGN KEY \`FK_60328bf27019ff5498c4b977421\``);
        await queryRunner.query(`ALTER TABLE \`group_user\` DROP FOREIGN KEY \`FK_c668a68c15f16d05c2a0102a51d\``);
        ...
        await queryRunner.query(`ALTER TABLE \`reward\` CHANGE \`deleted_at\` \`deleted_at\` datetime(0) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`reward\` ADD CONSTRAINT \`FK_7b3e48d8a28c1d1422f19c60752\` FOREIGN KEY (\`userId\`) REFERENCES \`user\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`DROP TABLE \`ky_luat\``);
    }
