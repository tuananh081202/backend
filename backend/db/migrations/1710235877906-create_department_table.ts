...
export class CreateDepartmentTable1710235877906 implements MigrationInterface {
    name = 'CreateDepartmentTable1710235877906'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`department\` (\`id\` int NOT NULL AUTO_INCREMENT, \`maPB\` varchar(255) NOT NULL, \`tenPB\` varchar(255) NOT NULL, \`description\` varchar(255) NOT NULL, \`createdBy\` varchar(255) NOT NULL DEFAULT 'Admin', \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleted_at\` datetime(6) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
